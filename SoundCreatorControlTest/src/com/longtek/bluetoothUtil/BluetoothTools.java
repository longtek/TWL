...
public class BluetoothTools {
	...
	private static BluetoothAdapter adapter = BluetoothAdapter.getDefaultAdapter();   	//获取本机蓝牙适配器
	 ...
	 * Action：到业务中的数据
	 */
	public static final String ACTION_DATA_TO_BOX = "ACTION_DATA_TO_BOX";
	//发送ＳＤ卡文件到BOX
	/**
	 * Action：发送文件的百分比
	 */
	...
	/**
	 * 设置蓝牙发现功能
	 * @param duration 持续时间 ，  设置蓝牙发现功能打开持续秒数（值为0至300之间的整数）
	 */
